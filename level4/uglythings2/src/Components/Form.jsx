...
export default function Form(props) {
  const { inputData, editInputData, handleSubmit, handleChange, editUgly } =
    useContext(UglyThingsContext);
  return (
    <form
      onSubmit={(e) => {
        props.shouldEdit ? editUgly(e, props.id) : handleSubmit(e);
      }}
    >
      <input
      ...
      <input
        ...
        name="description"
        value={
          props.shouldEdit ? editInputData.description : inputData.description
        }
      />
      <input
        onChange={(e) => handleChange(e, props.shouldEdit)}
